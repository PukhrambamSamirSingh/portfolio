const Feedbacks = () => {
    ...
    // }, []);
    return (
        <div className="w-full min-h-[50vh] p-4 md:px-12 lg:px-16 flex flex-col items-center gap-6 sm:gap-14" id="feedbacks">
            <h1 className="text-2xl sm:text-4xl font-semibold underline">Feedbacks</h1>
            <h3 className="text-xl italic">No feedbacks yet!</h3>
