...
const Skills = () => {
    return (
        <div className="w-full min-h-screen p-4 md:px-12 lg:px-16 flex flex-col items-center gap-6 sm:gap-14" id="skills">
            ...
            <div className="w-full h-full flex flex-col md:flex-row justify-between items-start gap-4 sm:gap-8">
                <div className="w-full md:w-1/2 grid grid-cols-4 md:grid-cols-3 xl:grid-cols-5 gap-2">
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-2">
                    ...
                    <span className="p-2 italic">{"I'm"} Pukhrambam Samir Singh, a self-taught web developer with over 2 years of experience in designing and developing MERN-STACK and responsive websites.</span>
                </div>
            </div>
        </div>
    )
